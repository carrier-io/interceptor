...
EXTRA_HOSTS = environ.get("EXTRA_HOSTS", "").strip()
...
POSTPROCESSOR_CONTAINER = environ.get('POSTPROCESSOR_CONTAINER', 'getcarrier/performance_results_processing:beta-3.1')
